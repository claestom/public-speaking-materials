# CloudBrew 2025 - Azure Monitor

Materials and resources for the CloudBrew 2025 Azure Monitor session covering the latest features and best practices for Microsoft's comprehensive monitoring solution.
...
- [Azure Monitor Logs](https://docs.microsoft.com/en-us/azure/azure-monitor/logs/data-platform-logs) & [Metrics](https://docs.microsoft.com/en-us/azure/azure-monitor/essentials/metrics-supported)
- [Quick Start Guide](https://docs.microsoft.com/en-us/azure/azure-monitor/essentials/quick-monitor-azure-resource)
